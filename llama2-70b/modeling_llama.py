...
def repeat_kv(hidden_states: torch.Tensor, n_rep: int) -> torch.Tensor:
    ...
    # hidden_states = hidden_states.expand(1, 8, 8, 1, 128)
    # return hidden_states.reshape(1, 64, 1, 128)
    ...
    # hidden_states = hidden_states.expand(batch, 8, 8, slen, 128)
    
    # return hidden_states.reshape(batch, 64, slen, 128)
...
class LlamaAttention(nn.Module):
    ...
    def forward(
        ...
        # print(bsz, q_len, self.num_heads, self.head_dim)
        # print(key_states.shape)
        ...
        # print(kv_seq_len, past_key_value, past_key_value[0])
        # rope
